...
function buscarImagenes() {
    ...
    const key = '31927687-053f53d9617108d471d05d74e'
...
function mostrarImagenes(imagenes) {
    ...
    // iterar sobre el arreglo de imgenes y construir el html
        ...
        <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
            <div class="bg-white">
                ...
                <div class="py-4">
                    ...
                    <a 
                        class="block w-full bg-blue-800 hover:bg-blue-500 text-white uppercase font-bold text-center rounded mt-3 p-1"
